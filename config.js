...
module.exports = {
  ...
  SESSION_ID: (process.env.SESSION_ID || 'levanter_2899947e95c28642b5b718c0cfd98dab76').trim(),
  DATABASE:
  ...
  ANTIWORDS: process.env.ANTIWORDS || 'idiot','sense',
  ...
  PERSONAL_MESSAGE: (process.env.PERSONAL_MESSAGE || 'hi how are you, i am unavailable just drop your message and I will reply soon ').trim(),
